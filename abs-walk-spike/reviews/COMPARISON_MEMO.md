...
**Audience:** The article author (whoever uses the `calledthird-editorial` skill next), and Hao for editorial sign-off.
...
- ⏸ Hao final editorial sign-off pending
- ⏸ Article drafting via `calledthird-editorial` skill — next step
